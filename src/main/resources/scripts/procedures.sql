...
CREATE OR REPLACE PROCEDURE SP_EJECUTAR_MATRICULA
(
...
BEGIN
    INSERT INTO ALUMNOS
    VALUES(
        SEQ_CODIGO_ALUMNO.NEXTVAL, -- Amor aqui ya hay una secuencia para le codigo del alumno
        A_APATERNO_ALU,
        A_AMATERNO_ALU,
        A_NOMBRE_ALU,
        A_TELEFONO_ALU,
...
CREATE OR REPLACE PROCEDURE SP_REGISTAR_COMPROBANTE
(
    C_NRO_COMPROBANTE CHAR,
    C_MONTO NUMBER,
    C_FECHA_EMISION TIMESTAMP,
