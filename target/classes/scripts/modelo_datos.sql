...
CREATE UNIQUE INDEX IDX_DNI_ALUMNO ON ALUMNOS(DNI_ALUMNO);
...
CREATE TABLE MATRICULA (
    ...
    P_ACADEMICO         NUMBER(4) NOT NULL,
    CONSTRAINT PK_MATRICULA PRIMARY KEY ( COD_SECCION,COD_GRADO,COD_ALU )
) TABLESPACE TS_SISTEMA_MATRICULA;

CREATE UNIQUE INDEX IDX_PERIODO_ACADEMICO 
ON MATRICULA(COD_ALU, P_ACADEMICO);
